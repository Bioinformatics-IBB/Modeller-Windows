...
def after_loop_lab2_2(pdb_name):
   new_text = pdb_name
   lab2_2 = Label(win, text='pdb_95.pir',font="Times 16 ", bg="white" ,anchor='w',padx=100,pady=5, fg='black',relief=SUNKEN).grid(row=2,column=1)
...
if __name__ == '__main__':   
   ...
   #Declaring Text
   lab1Text = Label(win, text="Modeller",font="Verdana 16 bold" ,anchor='w',padx=100,pady=5, fg='black',bg='#90A4AE').grid(row=0, column=3)
